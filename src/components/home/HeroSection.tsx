  ...
  return (
    <section className="relative h-screen flex items-center">
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://images.unsplash.com/photo-1628744404730-5e143358539b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1500&q=80')`,
